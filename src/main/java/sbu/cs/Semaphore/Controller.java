...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        Operator operator1 = new Operator("operator1", sm);
        Operator operator2 = new Operator("operator2", sm);
        Operator operator3 = new Operator("operator3", sm);
        Operator operator4 = new Operator("operator4", sm);
        Operator operator5 = new Operator("operator5", sm);
